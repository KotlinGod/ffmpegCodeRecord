...
//SDL------------------
    ...
    //SDL_AudioSpec
///    wanted_spec.freq = 44100;       ///这里我们不写死，可以通过pCodecCtx获得
    wanted_spec.freq = pCodecCtx->sample_rate;
    wanted_spec.format = AUDIO_S16SYS;
//    wanted_spec.channels = av_get_channel_layout_nb_channels(AV_CH_LAYOUT_STEREO);    //不用写死
    wanted_spec.channels = pCodecCtx->channels;
    wanted_spec.silence = 0;
    wanted_spec.samples = pCodecCtx->frame_size;        //每一帧音频的大小，aac是1024 mp3是1152
